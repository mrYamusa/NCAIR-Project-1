...
# Using the System method from os to clear the terminal after the username is entered
os.system('cls')

# Start Game 
print(gameIntro)
# Print School Entrance as part of the Intro then a 2 second delay
print(schoolFront1)
print(intro[0])
time.sleep(7)

# Lists containing the story line - round = [pretext + question, live, die]

round1 = [
    f"\nWith a creaking sound echoing as {user_name} tries to fall asleep, one thought keeps getting brought to mind, she has been said to make such sounds late at night. A footstep can can be heard creeping closer and closer. As the footsteps draw nearer, panic sets in. Will you hide under the bed, hoping to evade the danger? \n"
